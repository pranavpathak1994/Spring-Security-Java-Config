				...
				<div class="col-md-4 col-md-offset-4">
					<div class="login-panel panel panel-default">
						...
						<div class="panel-heading">
							<h1 class="panel-title">Welcome ${firstName} ${lastName } </h1>
						</div>
						<div class="panel-body">
							<div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><c:forEach items="${authority}" var="auth">${auth.authority}</c:forEach></div>
                                </div>
                                <div class="pull-right">${email } </div>
                            </div>
						</div>
						<c:url value="/authLogout" var="url"></c:url>
						<a href="${url }">
